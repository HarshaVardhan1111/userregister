...
<body>
	...
	<div class="container">
		<form method="post" action="register" class="form form--hidden"
			id="createAccount">
			<h1 class="form__title">Registration</h1>
			<div class="form__message form__message--error"></div>
			<div class="form__input-group">
				<input type="text" id="signupUsername" class="form__input"
					name="name" autofocus placeholder="Username" required="required">
			...
			<div class="form__input-group">
				<input type="password" class="form__input" autofocus name="password"
			...
			<div class="form__input-group">
				<input type="text" class="form__input" autofocus name="phonenumber"
					placeholder="Phonenumber" required="required">
				<div class="form__input-error-message"></div>
			</div>
			<button class="form__button" type="submit">Signup</button>
			<p class="form__text">
				<a class="form__link" href="./Login.jsp" id="linkLogin">Already
